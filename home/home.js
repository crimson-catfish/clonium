...
// Simulate server request to get room code
function createRoom() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch('/create-room', { method: 'POST' })];
                case 1:
                    response = _a.sent();
...
function joinRoom() {
    return __awaiter(this, void 0, void 0, function () {
        var roomCode, response, data, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch("/join-room/".concat(roomCode), { method: 'POST' })];
                case 2:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 3:
                    data = _a.sent();
                    if (data.success) {
                        statusMessage.textContent = "Successfully joined room: ".concat(roomCode);
                    }
                    else {
                        statusMessage.textContent = "Failed to join room: ".concat(roomCode, ". Please check the code.");
                    }
                    return [3 /*break*/, 5];
                case 4:
                    error_2 = _a.sent();
